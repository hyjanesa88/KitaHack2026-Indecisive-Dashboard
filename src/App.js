...
function Slide1({ isDark }) {
  return (
    <div
      className={`h-full relative overflow-hidden flex items-center justify-center p-6 ${
    ...
    >
      ...
      {/* Content */}
      <div
        className={`relative z-10 backdrop-blur-md rounded-3xl p-8 border shadow-xl max-w-2xl flex flex-col items-center text-center transition-all duration-300 ${
          isDark
      ...
      >
        ...
        <h1
          className={`text-2xl font-black leading-snug mb-6 max-w-lg ${
            isDark ? "text-white" : "text-slate-800"
          }`}
          style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
        >
...
function Slide2({ isDark }) {
  return (
    <div
      className={`h-full flex flex-col px-6 py-6 overflow-auto ${
...
function Slide3({ isDark }) {
  ...
  return (
    <div
      className={`h-full flex flex-col px-6 py-6 overflow-hidden ${
        isDark ? "bg-slate-900" : "bg-white"
      }`}
    >
      <div className="mb-4">
      ...
      {/* Enlarged Cards that fit the full height */}
      <div className="flex-1 grid grid-cols-3 gap-6 mb-2">
        {sdgs.map((sdg) => (
          <div
            key={sdg.num}
            className={`border rounded-3xl p-6 shadow-lg flex flex-col h-full ${
              isDark
          ...
          >
            ...
            {/* Bottom: Contribution Block */}
            <div
              className={`text-base p-4 rounded-2xl leading-relaxed border mt-4 ${
                isDark
    ...
    >
      ...
      <div className="grid grid-cols-4 gap-3 mb-6">
        {components.map((c, i) => (
          ...
          >
            <div className="flex items-center gap-2 font-black text-base leading-tight">
              {c.icon}
              <span>{c.title}</span>
            </div>
            <div
              className={`text-sm opacity-90 leading-relaxed flex-1 ${
                isDark ? "text-slate-300" : "text-slate-700"
              }`}
            >
              {c.desc}
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {stack.map((s) => (
          ...
          >
            ...
            <div className={`font-black text-lg ${isDark ? "text-white" : ""}`}>
              {s.tech}
            </div>
            <div
              className={`text-sm leading-relaxed ${
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {[
            ...
            item === "→" ? (
              ...
              <span
                key={i}
                className={`border rounded-xl px-4 py-2 text-sm font-semibold shadow-sm ${
                  isDark
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4 mb-5">
        ...
        >
          ...
          <div
            className={`font-bold text-base mb-1 ${isDark ? "text-white" : ""}`}
          >
        ...
        <div
          className={`border rounded-2xl p-5 col-span-2 ${
            isDark
        ...
        >
          ...
          <div
            className={`flex items-start gap-2 text-sm opacity-90 mb-4 ${
              isDark ? "text-slate-300" : ""
            }`}
          >
            <CheckCircle size={14} className="mt-1 shrink-0" />
          ...
          <div className="flex gap-3">
            {actionCards.map((c) => (
              <div
                key={c.label}
                className={`flex items-center gap-3 border rounded-xl p-3 shadow-sm flex-1 ${
                  isDark
                    ? "bg-slate-800 border-slate-700"
              ...
              >
                ...
                >
                  {/* Size reduced to text-[9px] to fit MARKET easily */}
                  <span
        ...
        <div className="flex flex-col gap-3">
          {challenges.map((c) => (
            ...
            >
              ...
              <ArrowRight
                size={20}
                className="text-emerald-500 shrink-0 mt-3"
              />
              <div
    ...
    >
      ...
      <div className="flex flex-col gap-3 flex-1 justify-center max-w-3xl mx-auto w-full mb-4">
        {phases.map((p) => (
          <div
            key={p.phase}
            className={`border border-l-4 rounded-2xl p-4 shadow-sm flex items-center gap-6 ${
              isDark
          ...
          >
            <div className="shrink-0 text-center w-20">
              ...
              <div
                className={`font-black text-3xl mt-0.5 ${
                  isDark ? "text-white" : "text-slate-800"
                }`}
              >
...
const SLIDES = [
  ...
  {
    id: 5,
    title: "Measurable Goals & Success Metrics",
    shortTitle: "Goals",
    component: Slide5,
  },
        ...
        <div className="flex gap-1 mb-3">
          {SLIDES.map((s, i) => (
            <button
              key={s.id}
              onClick={() => goTo(i)}
              className={`flex-1 text-center text-[11px] font-semibold py-1 px-1 rounded-lg transition-all duration-200 ${
                i === current

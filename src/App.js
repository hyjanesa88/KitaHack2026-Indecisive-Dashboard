...
const electricityShareData = [
  ...
  { source: "Oil", value: 0.6, fill: "#ca7584" },
  { source: "Nuclear", value: 0.0, fill: "#cccccc" },
...
const userFeedbackData = [
  {
    ...
    concern: "ai_making_bad_trades",
    battery: "no",
    premium: "yes",
    vsGrid: "cheaper",
    rating: "4",
    comment: "like the charts but would only use manual mode first",
  },
  {
    id: "U002",
    time: "2/26 11:47",
    ...
    trustAi: "no",
    useP2P: "definitely",
    feature: "carbon_tracking",
    concern: "a_selling_too_low",
    battery: "yes",
    premium: "yes",
    vsGrid: "about_same",
    rating: "5",
    comment: "finally a way to sell my excess solar without waiting for tnb",
  },
  {
    id: "U003",
    time: "2/26 14:22",
    ...
    vsGrid: "cheaper",
    rating: "3",
    comment: "idk looks cool i guess",
  },
  {
    id: "U004",
    time: "2/26 18:35",
    ...
    concern: "hacking_risk",
    battery: "yes",
    premium: "no",
    vsGrid: "same",
    rating: "5",
    comment: "been waiting for this since tnb rates went up last year",
  },
  {
    id: "U005",
    time: "2/27 08:12",
    ...
    vsGrid: "cheaper",
    rating: "3",
    comment: "interesting but not sure if i trust the ai with my money lol",
  },
  {
    id: "U006",
    time: "2/27 10:58",
    ...
    concern: "battery_damage",
    battery: "no",
    premium: "yes",
    vsGrid: "cheaper",
    rating: "4",
    comment: "good concept need to see real results before switching",
  },
  {
    id: "U007",
    time: "2/27 13:41",
    ...
    trustAi: "no",
    useP2P: "definitely",
    feature: "live_trading_signals",
    concern: "price_risk",
    battery: "yes",
    premium: "no",
    vsGrid: "same",
    rating: "5",
    comment: "love that i can see the ai reasoning behind each trade",
  },
  {
    id: "U008",
    time: "2/27 15:19",
    ...
    useP2P: "no",
    feature: "forecasting",
    concern: "too_complicated",
    battery: "no",
    premium: "no",
    vsGrid: "cheaper",
    rating: "2",
    comment: "too many numbers for me maybe simplify it",
  },
  {
    id: "U009",
    time: "2/27 17:54",
    ...
    trustAi: "no",
    useP2P: "maybe",
    feature: "carbon_tracker",
    concern: "profit_loss",
    battery: "yes",
    premium: "yes",
    vsGrid: "cheaper",
    rating: "4",
    comment: "showing my carbon offset to friends is a nice touch",
  },
  {
    id: "U010",
    time: "2/28 09:07",
    ...
    trustAi: "no",
    useP2P: "definitely",
    feature: "earn_from_solar",
    concern: "not_applicable",
    battery: "no",
    premium: "yes",
    vsGrid: "cheaper",
    rating: "4",
    comment: "i dont have panels but i like buying from neighbors who do",
  },
  {
    id: "U011",
    time: "2/28 11:23",
    ...
    concern: "battery_warranty",
    battery: "yes",
    premium: "no",
    vsGrid: "same",
    rating: "3",
    comment: "worried about battery cycles if ai trades too often",
  },
  {
    id: "U012",
    time: "2/28 14:45",
    ...
    trustAi: "no",
    useP2P: "maybe",
    feature: "peer_trading",
    concern: "not_interested",
    battery: "no",
    premium: "no",
    vsGrid: "cheaper",
    rating: "3",
    comment: "if my friends use it maybe i will too",
  },
  {
    id: "U013",
    time: "2/28 16:12",
    ...
    useP2P: "definitely",
    feature: "autopilot",
    concern: "profit_guarantee",
    battery: "yes",
    premium: "yes",
    vsGrid: "cheaper",
    rating: "5",
    comment: "just let it run and check weekly thats what i want",
  },
  {
    id: "U014",
    time: "2/28 18:08",
    ...
    useP2P: "no",
    feature: "none",
    concern: "ai_black_box",
    battery: "no",
    premium: "no",
    vsGrid: "cheaper",
    rating: "2",
    comment: "how do i know the ai isnt just guessing",
  },
  {
    id: "U015",
    time: "2/28 20:33",
    ...
    vsGrid: "same",
    rating: "4",
    comment: "need proper escrow or something so people dont get scammed",
  },
  {
    id: "U016",
    time: "3/1 10:22",
    ...
    useP2P: "definitely",
    feature: "easy_ui",
    concern: "price_too_high",
    battery: "no",
    premium: "yes",
    vsGrid: "cheaper",
    rating: "4",
    comment: "looks clean and modern better than tnb app",
  },
  {
    id: "U017",
    time: "3/1 12:57",
    ...
    trustAi: "no",
    useP2P: "definitely",
    feature: "energy_dashboard",
    concern: "data_security",
    battery: "yes",
    premium: "no",
    vsGrid: "same",
    rating: "5",
    comment: "please add dark mode oh wait its already dark mode nice",
  },
  {
    id: "U018",
    time: "3/1 15:14",
    ...
    vsGrid: "no",
    rating: "2",
    comment: "not putting my money into some ai thing i dont understand",
  },
  {
    id: "U019",
    time: "3/1 17:38",
    ...
    trustAi: "yes",
    useP2P: "definitely",
    feature: "profit_tracking",
    concern: "not_applicable",
    battery: "yes",
    premium: "yes",
    vsGrid: "cheaper",
    rating: "4",
    comment: "wish there was a widget for quick balance check",
  },
  {
    id: "U020",
    time: "3/1 19:51",
    ...
    vsGrid: "cheaper",
    rating: "3",
    comment: "just show me the cheapest option and ill buy it",
  },
  {
    id: "U021",
    time: "3/2 08:16",
    ...
    trustAi: "maybe",
    useP2P: "maybe",
    feature: "carbon_impact",
    concern: "battery_capacity",
    battery: "yes",
    premium: "no",
    vsGrid: "same",
    rating: "3",
    comment: "my battery is small hope the ai takes that into account",
  },
  {
    id: "U022",
    time: "3/2 10:43",
    ...
    concern: "confirmation_ui",
    battery: "no",
    premium: "yes",
    vsGrid: "cheaper",
    rating: "4",
    comment: "add a double check before executing trades please",
  },
  {
    id: "U023",
    time: "3/2 15:58",
    ...
    vsGrid: "cheaper",
    rating: "3",
    comment: "feels like a game interesting",
  },
  {
    id: "U024",
    time: "3/2 18:14",
  ...
  },
  {
    ...
    vsGrid: "no",
    rating: "1",
    comment: "i dont trust computers with my electricity",
  },
  {
    id: "U026",
    time: "3/3 11:47",
    ...
    trustAi: "maybe",
    useP2P: "maybe",
    feature: "forecast_chart",
    concern: "volatility",
    battery: "yes",
    premium: "no",
    vsGrid: "same",
    rating: "4",
    comment: "showing regime status was a smart addition",
  },
  {
    id: "U027",
    time: "3/3 14:22",
  ...
  },
  {
    ...
    useP2P: "definitely",
    feature: "sell_orders",
    concern: "market_timing",
    battery: "yes",
    premium: "yes",
    vsGrid: "cheaper",
    rating: "4",
    comment: "selling my extra power at night is genius",
  },
  {
    id: "U029",
    time: "3/3 18:39",
    ...
    vsGrid: "cheaper",
    rating: "3",
    comment: "can i export my transactions for tax purposes",
  },
  {
    id: "U030",
    time: "3/4 09:14",
    ...
    vsGrid: "same",
    rating: "4",
    comment: "hope the ai knows when to stop charging",
  },
  {
    id: "U031",
    time: "3/4 11:52",
    ...
    vsGrid: "cheaper",
    rating: "3",
    comment: "what if the ai learns wrong patterns",
  },
  {
    id: "U032",
    time: "2/26 19:28",
    ...
    trustAi: "no",
    useP2P: "definitely",
    feature: "carbon_offset",
    concern: "p2p_matching",
    battery: "yes",
    premium: "yes",
    vsGrid: "cheaper",
    rating: "4",
    comment: "i trust the numbers not the ai",
  },
  {
    id: "U033",
    time: "3/1 20:15",
    ...
    vsGrid: "no",
    rating: "2",
    comment: "worried my usage data gets sold",
  },
  {
    id: "U034",
    time: "3/3 20:07",
    ...
    trustAi: "maybe",
    useP2P: "maybe",
    feature: "profit_display",
    concern: "none",
    battery: "yes",
    premium: "yes",
    vsGrid: "cheaper",
    rating: "4",
    comment: "just want to see how much i earn daily",
  },
  {
    id: "U035",
    time: "3/4 14:33",
    ...
    vsGrid: "cheaper",
    rating: "3",
    comment: "i want to use it but need more testimonials first",
  },
  {
    id: "U036",
    time: "2/27 20:44",
    ...
    useP2P: "yes",
    feature: "energy_dashboard",
    concern: "battery_degradation",
    battery: "yes",
    premium: "no",
    vsGrid: "same",
    rating: "3",
    comment: "great ui but worried about long term battery health",
  },
  {
    id: "U037",
    time: "2/28 21:12",
    ...
    vsGrid: "cheaper",
    rating: "3",
    comment: "too many features for me",
  },
  {
    id: "U038",
    time: "3/2 20:55",
    ...
    vsGrid: "same",
    rating: "4",
    comment: "if grid goes down can we still trade p2p",
  },
  {
    id: "U039",
    time: "3/4 19:47",
    ...
    useP2P: "yes",
    feature: "easy_ui",
    concern: "ai_misleading",
    battery: "no",
    premium: "yes",
    vsGrid: "cheaper",
    rating: "4",
    comment: "fun to use but need clearer explanations",
  },
  {
    id: "U040",
    time: "3/1 21:33",
    ...
    useP2P: "no",
    feature: "none",
    concern: "complicated_interface",
    battery: "no",
    premium: "no",
    vsGrid: "no",
    rating: "1",
    comment: "too much going on for old people like me",
  },
];
...
function Slide1({ isDark }) {
  return (
    ...
    >
      ...
      <div
        className={`relative z-10 backdrop-blur-md rounded-3xl p-6 md:p-10 border shadow-xl max-w-3xl w-full flex flex-col items-center text-center transition-all duration-300 ${
          isDark
      ...
      >
        ...
        <p
          className={`font-bold uppercase tracking-widest text-sm md:text-base mb-4 ${
        ...
        <h1
          className={`text-2xl md:text-3xl font-black leading-snug mb-8 max-w-xl ${
            isDark ? "text-white" : "text-slate-800"
          }`}
          style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
        >
        ...
        <div className="flex flex-col md:flex-row gap-3 w-full max-w-2xl mt-2">
          {[
            ...
            <div
              key={sdg.num}
              className={`flex-1 flex items-center gap-3 border rounded-xl p-3 shadow-sm transition-all duration-300 ${
                isDark
            ...
            >
              <div
                className={`w-8 h-8 rounded-lg ${sdg.color} flex items-center justify-center shrink-0 shadow-sm`}
              >
                <span className="text-white">{sdg.icon}</span>
              </div>
              <div className="flex flex-col text-left">
                <span
                  className={`text-[10px] font-black uppercase tracking-widest ${sdg.text}`}
                >
                  SDG {sdg.num}
                </span>
                <span
...
function Slide2({ isDark }) {
  return (
    <div
      className={`h-full flex flex-col justify-center px-4 md:px-8 py-2 overflow-y-auto ${
    ...
    >
      <div className="mb-4 mt-2 text-center shrink-0">
        ...
        <h2
          ...
          style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
        >
          The Clean Energy Access Barrier
        </h2>
      </div>
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4 pb-4">
        ...
        <div
          className={`border rounded-3xl p-5 md:p-6 flex flex-col justify-center relative overflow-hidden ${
            isDark
        ...
        >
          ...
          >
            Malaysia relies heavily on fossil fuels, with Coal and Gas
            comprising roughly 80% of our 2024 electricity mix.
          </div>

          {/* Chart rendered at the top */}
          <div className="relative w-full h-[200px] mt-2 bg-white/5 dark:bg-black/10 rounded-xl p-2 pb-0">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Bar dataKey="value" barSize={14} radius={[0, 4, 4, 0]}>
                  {electricityShareData.map((entry, index) => (
        ...
        <div
          className={`border rounded-3xl p-5 md:p-6 flex flex-col justify-center ${
            isDark
        ...
        >
          ...
          >
            <p className="font-bold mb-3 md:text-lg">
              Under the new January 2026 Solar ATAP scheme:
            </p>
            ...
            >
              ...
              <p className="mb-3 italic text-sm md:text-base leading-relaxed">
                "(d) If the Energy exported exceeds the electricity consumed
                from the EUC or the MAQ, whichever is lower, during the Billing
                Period, such excess of the exported energy{" "}
                <span className="text-red-500 font-black underline">
                  shall be forfeited
                </span>
                ;"
              </p>
              <p className="italic text-sm md:text-base leading-relaxed">
                "(e) If the net bill amount is in negative value, it{" "}
                <span className="text-red-500 font-black underline">
...
function SlideSolution({ isDark }) {
  return (
    ...
    >
      ...
      <h1
        className={`text-6xl md:text-8xl font-black tracking-tighter opacity-10 ${
          isDark ? "text-white" : "text-slate-800"
        }`}
        style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
      >
...
function SlideTargetUser({ isDark }) {
  const users = [
    {
      ...
      desc: "No solar panels needed. Any smartphone user can instantly buy affordable, community-generated green energy.",
    ...
    },
    {
      ...
      role: "Prosumer",
      title: "Solar Owners",
      desc: "Monetize excess solar generation at better rates than the national grid — your rooftop, your revenue.",
      icon: <Sun size={28} />,
    ...
    },
    {
      ...
      desc: "Factories with large energy demands can secure local, clean energy at scale via a decentralized marketplace.",
  ...
  return (
    <div
      className={`h-full flex flex-col justify-center px-4 md:px-10 overflow-y-auto ${
        isDark ? "bg-slate-900" : "bg-slate-50"
      }`}
    >
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-5 pb-6">
        {users.map((u) => (
          <div
            key={u.role}
            className={`flex-1 border rounded-3xl p-6 md:p-8 flex flex-col justify-center transition-transform hover:-translate-y-1 ${
              isDark
          ...
          >
            ...
            <div
              className={`text-[10px] font-black tracking-[0.1em] uppercase mb-2 ${
...
function SlideTesting({ isDark }) {
  return (
    <div
      className={`h-full flex flex-col px-4 md:px-8 overflow-y-auto ${
        isDark ? "bg-slate-900" : "bg-slate-50"
      }`}
    >
      <div className="mb-4 mt-6 text-center shrink-0">
        ...
        >
          Tested by 40 Malaysian users (49% Aged 35+)
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <ShieldCheck
              size={24}
              className={
                isDark ? "text-emerald-400 mb-3" : "text-emerald-500 mb-3"
              }
            />
            <h3
            ...
            >
              AI automation is never switched on by default. Users choose when
              to let the system act.
            </p>
            <div
            ...
            >
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-[11px] font-bold bg-emerald-500/20 text-emerald-500 px-2 py-0.5 rounded">
                  0.87 — Auto ✓
                </span>
              </div>
              <div
          ...
          >
            ...
            >
              Safeguards ensure the AI never recommends impossible trades from
              input to output.
            </p>
            <div
              className={`rounded-xl p-3 border ${
            ...
            >
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-[11px] font-bold bg-amber-500/20 text-amber-500 px-2 py-0.5 rounded">
                  0.61 — Review ⚠️
                </span>
              </div>
              <div
          ...
          {[
            {
              ...
              title: "Pre-Prompt Constraints",
              desc: "Rules baked in before every AI call, scoping suggestions.",
            },
            {
              tag: "Layer 2",
              icon: <CheckCircle size={20} />,
              title: "Post-Response Validation",
              desc: "Every AI output is checked against real grid data.",
            },
            {
              tag: "Layer 3",
              icon: <Activity size={20} />,
              title: "ML Handles the Math",
              desc: "Forecast engine does heavy analysis. AI makes the final call.",
            },
          ].map((layer) => (
            <div
              key={layer.tag}
              className={`border rounded-2xl p-4 flex flex-col justify-center ${
                isDark
...
function SlideRoadmap({ isDark }) {
  const steps = [
    {
      ...
      desc: "Forging collaborations with key industry players and utilities.",
      color: "#10b981",
    ...
    },
    {
      ...
      desc: "Onboarding stakeholders to create a scalable trading network.",
      color: "#10b981",
      textColor: "text-emerald-500",
    },
    {
      ...
      desc: "Strengthening the ecosystem to support real-world deployment.",
      color: "#10b981",
      textColor: "text-emerald-500",
    },
    {
      ...
      desc: "Scaling beyond local markets into international networks.",
      color: "#3b82f6",
      textColor: "text-blue-500",
    },
    {
      phase: "Long-Term",
      label: "Borderless Trading",
      desc: "Enabling seamless energy exchange across communities.",
      color: "#3b82f6",
      textColor: "text-blue-500",
    },
    {
      ...
      desc: "Building a fully interconnected system without limitations.",
      color: "#3b82f6",
      textColor: "text-blue-500",
    },
  ];
  ...
  return (
    <div
      className={`h-full flex flex-col justify-center px-4 md:px-8 overflow-hidden ${
        isDark ? "bg-slate-900" : "bg-slate-50"
      }`}
    >
        ...
        <div className="min-w-[1000px] w-full relative h-[400px] flex flex-col justify-center px-6">
          ...
          <div className="absolute top-0 left-0 right-0 flex w-full select-none">
            <div className="w-1/2 flex flex-col items-center border-t-4 border-emerald-500 pt-4 px-4">
              <h3
                className={`text-xl md:text-2xl font-black uppercase tracking-wide text-emerald-500`}
              >
                Short-Term
              </h3>
            </div>
            <div className="w-1/2 flex flex-col items-center border-t-4 border-blue-500 pt-4 px-4">
              <h3
                className={`text-xl md:text-2xl font-black uppercase tracking-wide text-blue-500`}
              >
                Long-Term
              </h3>
            </div>
          ...
          <div
            className={`absolute left-4 right-4 h-1 border-t-4 border-dashed ${
            ...
            {steps.map((p, i) => {
              ...
              return (
                ...
                >
                  {/* Node on the line */}
                  <div
                    className="w-6 h-6 rounded-full border-[4px] z-10 shadow-md"
                    style={{
                  ...
                  <div
                    ...
                    } z-0 ${isTop ? "bottom-6 h-10" : "top-6 h-10"}`}
                  ></div>
                  ...
                  <div
                    ...
                    style={{
                      borderTopWidth: isTop ? "4px" : "1px",
                      borderBottomWidth: !isTop ? "4px" : "1px",
                      borderTopColor: isTop ? p.color : "",
                      borderBottomColor: !isTop ? p.color : "",
                    }}
                  >
                    <div
...
function Slide7({ isDark }) {
  return (
    <div
      className={`h-full flex flex-col items-center justify-center px-4 md:px-8 py-8 text-center relative ${
        isDark ? "bg-slate-900" : "bg-slate-50"
      }`}
    >
      <div className="absolute top-6 w-full text-center">
...
function Slide8_SDGs({ isDark }) {
  const sdgs = [
    {
      ...
      icon: <Sun size={28} className="text-slate-900" />,
    },
    {
      num: "12",
      color: "bg-emerald-500",
  ...
  return (
    <div
      className={`h-full flex flex-col justify-center px-4 md:px-8 py-4 overflow-y-auto ${
        isDark ? "bg-slate-900" : "bg-white"
      }`}
    >
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-4 pb-4">
        {sdgs.map((sdg) => (
          <div
            key={sdg.num}
            className={`border rounded-3xl p-5 md:p-8 shadow-lg flex flex-col ${
              isDark
                ? "bg-slate-800 border-slate-700"
                : "bg-white border-slate-100"
            }`}
          >
            <div className="flex flex-col gap-4 mb-4">
              ...
              <div>
                ...
                <div
                  className={`font-black text-xl md:text-2xl leading-tight mb-4 ${
                    isDark ? "text-white" : "text-slate-800"
                  }`}
                >
                  {sdg.title}
            ...
            <div
              className={`text-sm md:text-base p-4 md:p-5 rounded-2xl leading-relaxed border mt-auto ${
                isDark
                  ? "bg-slate-900/50 border-slate-700 text-slate-400"
                  : "bg-slate-50 border-slate-100 text-slate-600"
              }`}
            >
              <div className="font-bold mb-2 opacity-80 uppercase tracking-wider text-xs">
                EcoTrade Contribution
              </div>
              {sdg.contribution}
            </div>
          </div>
    ...
    >
      ...
      <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-4">
        {stack.map((s) => (
          <div
            key={s.layer}
            className={`border rounded-2xl p-4 flex flex-col gap-2 justify-center ${
          ...
          >
            ...
            <div
              className={`text-xs md:text-sm leading-relaxed ${
                isDark ? "text-slate-300" : "text-slate-700 opacity-90"
              }`}
            >
              {s.desc}
            </div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {[
            ...
            item === "→" ? (
              ...
              <span
                key={i}
                className={`border rounded-lg px-3 py-1.5 text-xs font-semibold shadow-sm ${
                  isDark
...
function Slide10_Graphs({ isDark }) {
  ...
  return (
    <div
      className={`h-full flex flex-col px-4 md:px-8 py-4 overflow-y-auto ${
        isDark ? "bg-slate-900" : "bg-white"
      }`}
    >
      <div className="mb-4 mt-4 text-center shrink-0">
      ...
      <div className="flex-1 flex flex-col gap-6 pb-6">
        ...
        <div
          className={`border rounded-3xl p-5 md:p-6 shadow-sm overflow-hidden flex flex-col ${
            isDark
              ? "bg-slate-800 border-slate-700"
              : "bg-slate-50 border-slate-100"
          }`}
        >
          <h3
            className={`font-bold text-lg mb-1 shrink-0 ${
              isDark ? "text-white" : "text-slate-800"
            }`}
          >
          ...
          <div
            className={`text-[10px] mt-3 font-medium shrink-0 ${
        ...
        >
          ...
          >
            Share of Electricity Production by Source, Malaysia (2024)
          </h3>
          ...
          >
            Data source: Ember (2026); Energy Institute - Statistical Review of
            World Energy (2025)
          </div>
        </div>
      </div>
    ...
    >
      <div className="mb-4 mt-4 text-center shrink-0">
        ...
        <h2
          ...
          style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
        >
          User Feedback (CSV Data)
        </h2>
      </div>

      <div
        className={`flex-1 rounded-3xl border shadow-sm overflow-hidden flex flex-col ${
              ...
              {userFeedbackData.map((row) => (
                <tr
                  ...
                  className={`border-b last:border-0 transition-colors ${
                    isDark
                      ? "border-slate-700/50 hover:bg-slate-700/30 text-slate-300"
                ...
                >
                  ...
                  <td className="p-4 whitespace-nowrap text-xs opacity-80">
                    {row.concern}
                  </td>
                  <td className="p-4 uppercase text-[10px] font-bold">
                    {row.battery}
                  ...
                  <td className="p-4 italic opacity-90 text-xs">
                    "{row.comment}"
                  </td>
                </tr>
              ))}
...
const SLIDES = [
  ...
  },
  {
    ...
    shortTitle: "Solution",
    appendix: false,
    component: SlideSolution,
  },
  {
    id: 4,
    title: "Target User",
    shortTitle: "Target User",
    appendix: false,
    component: SlideTargetUser,
  },
  {
    id: 5,
    title: "User Testing",
  ...
  },
  {
    ...
    shortTitle: "Graphs",
    appendix: true,
    component: Slide10_Graphs,
  },
  {
    id: 11,
    title: "User Feedback",
    shortTitle: "Feedback CSV",
    appendix: true,
    component: Slide11_UserFeedback,
  },
];
    ...
    >
      <div className="w-full max-w-6xl h-screen md:h-[95vh] flex flex-col pt-2 pb-2">
        ...
        <div className="flex flex-wrap md:flex-nowrap items-center gap-1.5 mb-4 px-1">
          <span
            className={`text-[10px] md:text-xs font-black tracking-widest mr-2 ${
              isDark ? "text-slate-500" : "text-slate-400"
            }`}
          >
            APPENDIX:
        ...
        {/* Main Slide Card */}
        <div
          className={`flex-1 min-h-0 rounded-3xl shadow-2xl overflow-hidden transition-all duration-200 flex flex-col ${
            isDark
